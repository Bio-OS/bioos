...
const (
	...
	NotebookService_GetNotebook_FullMethodName    = "/proto.NotebookService/GetNotebook"
)
...
func (c *notebookServiceClient) GetNotebook(ctx context.Context, in *GetNotebookRequest, opts ...grpc.CallOption) (*GetNotebookResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotebookService_GetNotebook_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
